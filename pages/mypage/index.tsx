      ...
      <section className="flex flex-col justify-center items-center py-12 border-b border-neutral-300">
        ...
        <div>
          ...
          <div className="px-10 text-gray-500">
            ...
            <p>
              Mamá없는 Corea 축구 잘 봤다 사실 나는 오래전에 Naturalización했다. Español으로 한국과
              상관 없어요 나 Gracias 그 동안의 관심. Bastardo들아 자꾸 엮는다 나랑 Corea?? 하지마라
              다시 한번 말합니다. 나는 이제 Español 사람 아니면 가르쳐준다 나는. 너의 Mamá에게 Sexo.
            </p>
          </div>
          <div></div>
        </div>
